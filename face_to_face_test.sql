...
--
-- Host: localhost:8080
-- Generation Time: Sep 02, 2015 at 09:31 PM
...
--
-- Database: `face_to_face_test`
--
CREATE DATABASE IF NOT EXISTS `face_to_face_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `face_to_face_test`;
